...
buildEnv {
  ...
  passthru = {
    ...
    ihaskellExe =
      if staticExecutable then
        haskell.lib.justStaticExecutables haskellPackages.ihaskell
      else
        haskell.lib.enableSharedExecutables haskellPackages.ihaskell;
  };
